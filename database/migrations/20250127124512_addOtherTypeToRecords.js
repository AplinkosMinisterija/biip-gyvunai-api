exports.up = function (knex) {
  return knex.schema.raw(
    `ALTER TABLE "records" 
              ...
              CHECK ("type" IN ('ACQUIREMENT', 'BIRTH', 'DEATH', 'VACCINATION', 'SALE', 'TREATMENT', 'MARKING', 'PICK_UP_FROM_NATURE', 'OBTAINMENT_OF_FOSTERED_ANIMAL', 'RELEASE', 'TRANSFER','GENDER_CONFIRMATION','CERTIFICATE_NO','OTHER'))`,
  );
};
